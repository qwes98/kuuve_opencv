...
#if WEBCAM
	image_sub_ = nh_.subscribe("/usb_cam/image_raw", 100, &NarrowDriveNode::imageCallback, this);
#elif	PROSILICA_GT_CAM
	image_sub_ = nh_.subscribe("/camera/image_raw", 100, &NarrowDriveNode::imageCallback, this);
#endif
