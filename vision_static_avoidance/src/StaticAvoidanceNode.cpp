...
StaticAvoidanceNode::StaticAvoidanceNode()
{
	nh_ = ros::NodeHandle("~");
...
void StaticAvoidanceNode::imageCallback(const sensor_msgs::ImageConstPtr& image)
{
	Mat raw_img;
	try{
...
Mat StaticAvoidanceNode::parseRawimg(const sensor_msgs::ImageConstPtr& image)
{
...
void StaticAvoidanceNode::getRosParamForConstValue(int& width, int& height, int& steer_max_angle, int& detect_line_count, int& sustaining_time)
{
...
void StaticAvoidanceNode::getRosParamForUpdate()
{
	int paramArr[7];
...
#if RC_CAR
std_msgs::String StaticAvoidanceNode::makeControlMsg(int steer)
{
...
void StaticAvoidanceNode::printData(std_msgs::String control_msg)
{
...
#elif SCALE_PLATFORM
ackermann_msgs::AckermannDriveStamped StaticAvoidanceNode::makeControlMsg()
{
...
void StaticAvoidanceNode::printData()
{
 	cout << "#### Algorithm Time ####" << endl;
	cout << "it took : " << visionpathplanner_ptr_->getOnceDetectTime() << "ms, " << "avg: " << visionpathplanner_ptr_->getAvgDetectTime() << " fps : " << 1000 / visionpathplanner_ptr_->getAvgDetectTime() << endl;
	cout << "#### Control ####" << endl;
